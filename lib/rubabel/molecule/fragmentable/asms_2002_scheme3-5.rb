...
module Rubabel
  class Molecule
    module Fragmentable
      ::Rule_names << def jasms_2002_3_b1(only_uniqs=true)
        fragment_sets = []
      ...
      ::Rule_names << def jasms_2002_3_b2(only_uniqs=true)
        fragment_sets = []
        fragment = lambda do |*arr|
          # duplicate
      ...
      ::Rule_names << def jasms_2002_3_b2_water_loss(only_uniqs=true)
        fragment_sets = []
        fragment = lambda do |*arr|
          # duplicate
      ...
      ::Rule_names << def jasms_2002_3_b2_formaldehyde_loss(only_uniqs=true)
        fragment_sets = []
        fragment = lambda do |*arr|
          # duplicate
      ...
      ::Rule_names << def jasms_2002_4_g1(only_uniqs=true)
        fragment_sets = []
        fragment = lambda do |*arr|
          # duplicate
      ...
      ::Rule_names << def jasms_2002_4_g2a_prime(only_uniqs=true)
        fragment_sets = []
        fragment = lambda do |*arr|
          # duplicate
          (nmol, (alcohol_oxygen, alcohol_carbon, nitrogen)) = self.dup_molecule(arr)
      ...
      ::Rule_names << def jasms_2002_4_g2a(only_uniqs=true)
        fragment_sets = []
        fragment = lambda do |*arr|
          # duplicate
      ...
      ::Rule_names << def jasms_2002_4_g2a_formaldehyde_loss(only_uniqs=true)
        fragment_sets = []
        fragment = lambda do |*arr|
          # duplicate
      ...
      ::Rule_names << def jasms_2002_4_g2a_prime_water_loss(only_uniqs=true)
        fragment_sets = []
        fragment = lambda do |*arr|
          # duplicate
      ...
      ::Rule_names << def jasms_2002_5_e1_water_loss(only_uniqs=true)
        fragment_sets = []
        fragment = lambda do |*arr|
          # duplicate
      ...
      ::Rule_names << def jasms_2002_5_e2(only_uniqs=true)
        fragment_sets = []
        fragment = lambda do |*arr|
          # duplicate
      ...
      ::Rule_names << def jasms_2002_5_e2_water_loss(only_uniqs=true)
        fragment_sets = []
        fragment = lambda do |*arr|
          # duplicate
      ...
      ::Rule_names << def jasms_2002_5_e5_formaldehyde_loss(only_uniqs=true)
        fragment_sets = []
        fragment = lambda do |*arr|
          # duplicate
